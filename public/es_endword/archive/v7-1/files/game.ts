...
class Game {
    ...
    private correctMessage: string = ""; // 추가: 올바른 단어 입력 시 표시할 메시지
    private correctMessageTimer: number = 0; // 추가: 올바른 메시지 타이머
    private readonly CORRECT_MESSAGE_DURATION = 1500; // 추가: 올바른 메시지 표시 시간 (1.5초)
    ...
    private resetGame() {
        ...
        this.correctMessage = ""; // 추가: 메시지 초기화
        this.correctMessageTimer = 0; // 추가: 메시지 타이머 초기화
    ...
    private startGame() {
        ...
        this.hiddenInput.value = this.userInput; // 현재 사용자 입력을 숨겨진 input에 반영 (초기에는 비어있음)
    ...
    private drawPlayingScreen() {
        ...
        } else if (this.correctMessage) { // 오류 메시지가 없을 때만 올바른 단어 메시지 표시
    ...
    private submitWord() {
        ...
        // 입력 제출 직후, 사용자 입력 필드를 즉시 초기화하여 시각적인 잔여물을 제거합니다.
        this.userInput = "";
        this.hiddenInput.value = "";

        // 새로운 단어를 제출하면 이전의 올바른/오류 메시지를 초기화합니다.
        this.errorMessage = "";
        this.errorMessageTimer = 0;
        this.correctMessage = "";
        ...
        this.score++;
        this.showCorrectMessage("정답!"); // 올바른 단어 메시지 표시
    }
    ...
    private showCorrectMessage(message: string) {
