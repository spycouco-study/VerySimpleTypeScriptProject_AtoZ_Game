...
class BubbleMatchGame {
    ...
    private SPRITE_SHEET_PATH: string = 'animals.png';
    ...
    private BGM_PATH: string = 'bgm.mp3';
    private EAT_SFX_PATH: string = 'pop.mp3'; // assets\pop.mp3로 경로 수정
    // --- 배경 이미지 관련 새 속성 ---
    private backgroundImage: HTMLImageElement | null = null; // 배경 이미지를 위한 새 속성
    private BACKGROUND_IMAGE_PATH: string = 'back.png'; // 배경 이미지 경로
    // --- 애셋 관련 끝 ---
    // --- 애니메이션 관련 새 속성 ---
    ...
    private POP_EFFECT_SPRITE_PATH: string = 'bubble_effect.png';
