...
interface ControlsConfig {
    ...
    lightPunch: string;
    heavyKick: string;
    block: string; // Added: Control for blocking
}
...
interface GameSettings {
    ...
    blockDamageReduction: number; // Added: e.g., 0.7 for 70% damage reduction
...
enum CharacterState {
    ...
    ATTACKING,
    HIT,
    BLOCKING, // Added: State for blocking
}
    ...
    changeState(newState: CharacterState) {
        ...
        switch (newState) {
            ...
            case CharacterState.HIT:
                ...
                break;
            case CharacterState.BLOCKING: // NEW STATE
