...
class Game {
    ...
    constructor() {
        ...
        // Apply basic style resets to body and html to ensure consistent positioning
        // This helps prevent default browser margins/padding from offsetting the canvas.
