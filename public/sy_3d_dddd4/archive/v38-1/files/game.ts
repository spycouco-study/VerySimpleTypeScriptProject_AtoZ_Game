...
class Game {
    ...
    private async init() {
        ...
        this.defaultObjectMaterial = new CANNON.Material('defaultObjectMaterial'); // ADDED: Material for placed objects
    ...
    private updatePlayerMovement() {
        ...
        // Apply air control factor if player is in the air
        ...
        if (moving) {
            ...
            if (this.numGroundContacts === 0) {
                // Player is in the air: apply configurable air deceleration
                ...
                // Player is on the ground: Cannon.js ContactMaterial friction will handle deceleration.
