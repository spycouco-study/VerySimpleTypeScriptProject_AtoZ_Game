...
function draw() {
    ...
    if (backgroundImage) {
        ...
        // This block is executed if backgroundImage is not successfully loaded.
        console.warn(`Background image '${gameData.gameSettings.backgroundImageName}' not found in loaded assets. Using fallback.`);
