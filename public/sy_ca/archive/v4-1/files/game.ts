...
class Game {
     ...
     */
    private drawSoundToggleButton(): void {
        const buttonSize = 30;
        const padding = 10;
        const btnX = this.canvas.width - buttonSize - padding;
        const btnY = padding;
        ...
        if (soundImg) {
            ...
            // Use config text for fallback button
    ...
    private drawTitleScreen() {
        ...
        this.drawSoundToggleButton(); // Draw sound button on title screen
    }
    ...
    private drawInstructionsScreen() {
        ...
        this.drawSoundToggleButton(); // Draw sound button on instructions screen
    }
    ...
    private drawGamePlaying() {
        ...
        this.drawSoundToggleButton(); // Draw sound button on playing screen
    }
    ...
    private drawGameOverScreen(win: boolean) {
        ...
        this.drawSoundToggleButton(); // Draw sound button on game over screen
    }
