...
class Player extends GameObject {
    ...
    shoot() {
        const bullet = new Bullet(new Vector2(this.pos.x, this.pos.y - this.height / 2), this.bulletTypeConfig.width, this.bulletTypeConfig.height, this.bulletTypeConfig.imageName, this.bulletTypeConfig.damage, 0, // Player bullets shoot straight up, so velX is 0
...
class Enemy extends GameObject {
    ...
    shoot(playerPos, customBulletSpeed = null) {
        ...
        const bullet = new Bullet(new Vector2(startX, startY), this.bulletTypeConfig.width, this.bulletTypeConfig.height, this.bulletTypeConfig.imageName, this.bulletTypeConfig.damage, velX, // Calculated X velocity
...
class Particle extends GameObject {
    constructor(pos, size, lifeTime, vel, initialColor, targetColor = initialColor) {
...
function startGame() {
    ...
    player = new Player(new Vector2(gameData.gameSettings.canvasWidth / 2, gameData.gameSettings.canvasHeight - 50), playerConfig, playerBulletConfig, gameData.gameSettings);
...
function spawnBoss(bossType) {
    ...
    bossInstance = new Boss(new Vector2(gameData.gameSettings.canvasWidth / 2, -bossConfig.height / 2), bossConfig, bossBulletConfig);
...
function gameLoop(currentTime) {
    ...
    if (deltaTime > 0.1)
        return; // Cap deltaTime to prevent physics weirdness on lag spikes
    update(deltaTime);
    draw();
}
