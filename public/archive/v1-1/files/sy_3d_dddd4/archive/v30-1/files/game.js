...
class Game {
  ...
  createPlayer() {
    ...
    this.playerBody = new CANNON.Body({
      ...
      shape: playerShape,
      fixedRotation: true
      // Prevent the player from falling over/rolling (simulates a character)
    });
