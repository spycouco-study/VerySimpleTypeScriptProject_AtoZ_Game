...
class Game {
    ...
    private createPlayer() {
        ...
        const playerGeometry = new THREE.SphereGeometry(1, 32, 32); // Radius 1, 32 segments for smoothness
        ...
        // Player physics body (Cannon.js sphere shape)
        const playerShape = new CANNON.Sphere(1); // Radius 1 for physics
        this.playerBody = new CANNON.Body({
            ...
            shape: playerShape,
            fixedRotation: true // Prevent the player from falling over/rolling (simulates a character)
        });
