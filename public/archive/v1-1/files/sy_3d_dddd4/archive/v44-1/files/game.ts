...
class Game {
    ...
    constructor() {
        ...
        // Fix: Apply basic CSS resets to html and body to prevent default margins/scrollbars
        // which can cause subtle layout shifts, especially when elements are dynamically added/removed.
    ...
    private async init() {
        ...
        this.setupGameUI(); // NEW: Setup score display
    ...
    private startGame() {
        ...
        // Fix: Re-apply aspect ratio after removing the title screen.
        // This ensures the canvas is correctly sized and centered based on the
        // current window dimensions, accounting for any subtle changes (e.g., scrollbar removal).
        this.applyFixedAspectRatio();
    }
