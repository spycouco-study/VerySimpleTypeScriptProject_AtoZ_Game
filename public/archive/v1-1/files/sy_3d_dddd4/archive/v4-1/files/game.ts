...
class Game {
    ...
    private onMouseMove(event: MouseEvent) {
        ...
        if (this.state === GameState.PLAYING && this.isPointerLocked) {
            ...
            // Changed from -= to += to invert mouse Y-axis as per user request.
    ...
    private onPointerLockChange() {
        if (document.pointerLockElement === this.canvas ||
            ...
            (document as any).mozPointerLockElement === this.canvas) { // Corrected webkitPointerLockElement to webkitPointerLockElement
