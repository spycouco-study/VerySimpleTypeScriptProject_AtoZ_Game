...
class Game {
  ...
  async init() {
    ...
    this.world.addEventListener("beginContact", (event) => {
      ...
      if (!bodyA || !bodyB) {
        console.warn("Cannon.js beginContact event received with undefined bodyA or bodyB.", event);
        return;
      }
    ...
    this.world.addEventListener("endContact", (event) => {
      ...
      let bodyB = event.bodyB;
      if (!bodyA || !bodyB) {
        console.warn("Cannon.js endContact event received with undefined bodyA or bodyB.", event);
        return;
      }
      if (bodyA === this.playerBody || bodyB === this.playerBody) {
        const otherBody = bodyA === this.playerBody ? bodyB : bodyA;
