...
class Game {
    ...
    private async init() {
        ...
        this.world.addEventListener('beginContact', (event) => {
            ...
            // Defensive check: Ensure both bodies are defined before proceeding
            // This addresses the "Cannot read properties of undefined (reading 'mass')" error.
            if (!bodyA || !bodyB) {
            ...
            if (bodyA === this.playerBody || bodyB === this.playerBody) {
                ...
                // Safely check if 'otherBody' is defined before accessing 'mass'
                // This is the direct fix for the reported error.
    ...
    private syncMeshesWithBodies() {
        ...
        for (const enemy of this.enemies) {
            if (!enemy.shouldRemove) {
                ...
                enemy.mesh.quaternion.copy(enemy.body.quaternion as unknown as CANNON.Quaternion);
            }
        }
    }
}
