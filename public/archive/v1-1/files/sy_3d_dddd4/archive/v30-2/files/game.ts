...
class Game {
    ...
    private updatePlayerMovement() {
        ...
        if (moving) {
            ...
            // This friction should only apply if the player is currently on the ground.
            ...
            // If in the air and not moving, horizontal velocity will naturally persist (coast)
            // due to Cannon.js physics, as no specific 'air resistance' is applied horizontally.
        }
