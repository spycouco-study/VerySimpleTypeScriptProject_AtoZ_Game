...
enum ItemType {
    WaterBalloonUp = "item_water_balloon_up", // Changed from BombUp to WaterBalloonUp
...
class Player extends Character {
    ...
    collectItem(item: Item, game: Game): void {
        ...
        switch (item.type) {
            case ItemType.WaterBalloonUp: this.maxBombs++; break; // Changed BombUp to WaterBalloonUp
...
class Item extends GameObject {
    ...
    constructor(gx: number, gy: number, type: ItemType, tileSize: number, lifespan: number) {
        // The imageName for an item is its type value (e.g., "item_water_balloon_up")
    ...
    private render(): void {
        ...
        switch (this.gameState) {
            ...
            case GameState.Playing:
                ...
                break;
            case GameState.GameOver:
                this.renderEndScreen("GAME OVER", "lose");
                break;
            case GameState.Victory:
                this.renderEndScreen("VICTORY!", "win");
                break;
        }
    }
