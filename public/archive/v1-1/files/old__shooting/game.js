...
class EnemyBullet {
    constructor(x, y, speed = 200, directionX = 0) {
        this.width = 4;
        this.height = 10;
        this.x = x;
        this.y = y;
...
class Enemy {
    constructor(x, y, config) {
        this.width = 30;
        this.height = 30;
        this.timeAlive = 0; // To track elapsed time for sine wave calculation
        this.lastShotTime = 0;
        this.x = x;
        this.y = y;
...
const bullets = [];
const enemies = [];
const enemyBullets = []; // New array for enemy bullets
