...
class Game {
    ...
    async init() {
        ...
        // Removed the click listener on renderer.domElement for game start/restart
        // as UI overlay elements would block it.

        // Add click listeners to the specific UI overlay elements
