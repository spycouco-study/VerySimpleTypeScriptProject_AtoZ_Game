...
function extractWordChosungs(word) {
    let chosungs = '';
...
(function (GameState) {
    ...
    GameState[GameState["GAME_WON"] = 3] = "GAME_WON"; // Player guessed all unique words
})(GameState || (GameState = {}));
class Game {
    constructor(canvasId) {
        this.gameLoopRequestId = 0;
        this.gameState = GameState.TITLE;
        this.lastTime = 0;
        this.currentChosung = '';
        this.currentRoundTime = 0;
        this.lives = 0;
        this.usedWords = new Set(); // Words correctly submitted by player
        this.score = 0;
        this.availableProblemWords = []; // Words available to be presented as chosung problems
        this.validWordsSet = new Set(); // All words from config.wordList for quick lookup
    ...
    drawText(text, x, y, fontConfig, align = 'center', baseline = 'middle') {
    ...
    drawImageScaled(imageName, x, y, width, height) {
