    ...
    private drawPlaying(): void {
        ...
        this.snake.forEach((segment, index) => {
            ...
            if (index === 0 && snakeHeadImage) { // Head
                ...
                // Assume snake_head.png asset has its "nose" and "crown" pointing UP at 0 degrees rotation.
                // Rotate the image so the "crown" (which is also the leading part in this top-down view)
                // points in the current direction of movement.
                let rotationAngle = 0;
                switch (this.currentDirection) {
                    case Direction.UP: rotationAngle = 0; break;
                    case Direction.DOWN: rotationAngle = Math.PI; break; // 180 degrees clockwise
                    case Direction.LEFT: rotationAngle = -Math.PI / 2; break; // 90 degrees counter-clockwise
                    case Direction.RIGHT: rotationAngle = Math.PI / 2; break; // 90 degrees clockwise
                }
