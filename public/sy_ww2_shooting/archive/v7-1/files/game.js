...
class Game {
  ...
  // Helper to draw an image using 'object-fit: contain' logic, centered
  ...
  renderTitleScreen() {
    ...
    if (titleImage) {
      this.drawImageContain(this.ctx, titleImage, this.canvas.width, this.canvas.height);
    } else {
