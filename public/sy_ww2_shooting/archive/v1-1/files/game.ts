...
class Bullet extends GameObject {
    ...
    constructor(x: number, y: number, width: number, height: number, imageName: string, speed: number, damage: number, type: "player" | "enemy") {
...
window.onload = () => {
    // Attempt to load "Press Start 2P" font for retro feel, fallback to Arial.
